        ...
        <x-card padding="none" border class="p-8 md:p-10 min-h-[300px] flex items-center justify-center">
            @if(!$pendaftaran)
                <div class="text-center max-w-md">
                    <div class="w-20 h-20 bg-purple-50 text-[#6B21A8] rounded-2xl flex items-center justify-center mx-auto mb-6">
            ...
            @else
                <div class="w-full">
                    <div class="flex flex-col md:flex-row items-center gap-10">
                        <div class="w-40 h-40 bg-gray-50 rounded-2xl flex items-center justify-center text-gray-400 shrink-0 border border-gray-100">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            @else
                                ...
                                @endphp
                                <div class="badge badge-lg {{ $statusColor }} border-none font-black py-5 px-8 rounded-2xl uppercase tracking-widest text-xs">
