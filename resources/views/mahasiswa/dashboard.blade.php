...
>
    <div class="flex flex-col md:flex-row items-center gap-4">
        <div class="{{ $pendaftaran ? 'bg-white/10 border-white/20' : 'bg-red-500/10 border-red-500/20' }} backdrop-blur-md px-5 py-2.5 rounded border text-white flex items-center gap-3 shadow-xl">
...
<div class="space-y-8">
    ...
    <x-card padding="large" border class="bg-red-50 !border-red-100 relative group transition-all">
        ...
        <div class="relative z-10 flex flex-col md:flex-row items-center gap-6">
            <div class="w-16 h-16 rounded bg-red-500 text-white flex items-center justify-center shadow-xl shadow-red-200 shrink-0">
    ...
    <div class="lg:col-span-8 space-y-8 min-w-0">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <x-card padding="none" border class="p-6 flex flex-col items-center text-center group hover:shadow-md transition-all">
                <div class="w-12 h-12 rounded bg-orange-50 flex items-center justify-center text-[#F49E0A] mb-4">
            ...
            <x-card padding="none" border class="p-6 flex flex-col items-center text-center group hover:shadow-md transition-all">
                <div class="w-12 h-12 rounded bg-blue-50 flex items-center justify-center text-blue-600 mb-4">
                ...
                <span class="text-[10px] font-black {{ $laporan ? 'text-blue-600 bg-blue-50 border-blue-100' : 'text-gray-300 bg-gray-50 border-gray-100' }} px-4 py-2 rounded mb-1 uppercase tracking-widest border">
            ...
            <x-card padding="none" border class="p-6 flex flex-col items-center text-center group hover:shadow-md transition-all">
                <div class="w-12 h-12 rounded bg-purple-50 flex items-center justify-center text-[#6B21A8] mb-4">
        ...
        <!-- Main Action Section -->
        <x-card padding="none" border class="p-8 md:p-10 min-h-[300px] flex items-center justify-center">
            @if(!$pendaftaran)
                <div class="text-center max-w-md">
                    <div class="w-20 h-20 bg-purple-50 text-[#6B21A8] rounded flex items-center justify-center mx-auto mb-6">
                    ...
                    @elseif($mahasiswa->status_magang === 'Rejected')
                        <div class="bg-red-50 text-red-700 p-6 rounded border border-red-100 flex flex-col items-center gap-3">
                    ...
                    @else
                        <div class="bg-orange-50 text-orange-700 p-6 rounded border border-orange-100 flex flex-col items-center gap-3">
            ...
            @else
                <div class="w-full">
                    <div class="flex flex-col md:flex-row items-center gap-10">
                        <div class="w-40 h-40 bg-gray-50 rounded flex items-center justify-center text-gray-400 shrink-0 border border-gray-100">
                             <svg xmlns="http://www.w3.org/2000/svg" class="h-20 w-20" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>
                        </div>
                        <div class="text-center md:text-left flex-1">
                            <span class="text-[10px] font-black text-[#6B21A8] uppercase tracking-[0.3em] mb-3 block">Info Perusahaan</span>
                ...
                <div>
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            @if(!$pendaftaran)
                                <div class="badge badge-lg bg-gray-100 text-gray-500 border-none font-bold py-4 px-6 rounded uppercase tracking-widest text-[10px]">No Data</div>
                            @else
                                @php
                                    $statusColor = [
                                        'Pending' => 'bg-orange-50 text-orange-600',
                                        'Aktif' => 'bg-green-50 text-green-600',
                                        'Selesai' => 'bg-purple-50 text-[#6B21A8]',
                                        'Ditolak' => 'bg-red-50 text-red-600'
                                    ][$pendaftaran->status_magang] ?? 'bg-gray-50 text-gray-600';
                                @endphp
                                <div class="badge badge-lg {{ $statusColor }} border-none font-black py-5 px-8 rounded uppercase tracking-widest text-xs">
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-3 bg-gray-50 p-3 rounded border border-gray-100">
                                <div class="w-8 h-8 rounded bg-white flex items-center justify-center text-[#6B21A8] shadow-sm">
