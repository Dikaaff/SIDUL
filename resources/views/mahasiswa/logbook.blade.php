...
<div class="max-w-7xl mx-auto pb-20">
    @if(!$isPeriodeOpen)
    <div class="mb-6 bg-red-50 border border-red-100 rounded p-4 flex items-center gap-4 text-red-600">
...
<x-modal id="logbook_modal" title="Tambah Catatan Baru ✍️" subtitle="Pastikan informasi yang Anda masukkan akurat." color="purple">
    <form action="{{ route('mahasiswa.logbook.store') }}" method="POST" class="space-y-6">
        ...
        <div class="form-control">
            ...
            <textarea name="logbook" placeholder="Tuliskan detail pekerjaan Anda hari ini..." class="textarea textarea-bordered h-48 bg-gray-50 border-none rounded text-sm font-bold text-gray-800 p-6 focus:bg-white focus:ring-4 focus:ring-[#6B21A8]/5 transition-all outline-none resize-none" required></textarea>
        </div>
