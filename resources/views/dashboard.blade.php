...
@section('header')
<div class="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-primary p-6 rounded-2xl shadow-lg mt-2">
    <div>
    ...
    <div class="flex gap-3">
        <button onclick="document.getElementById('dokumen_modal').showModal()" class="btn border-none hover:bg-opacity-90 bg-secondary text-white btn-sm rounded-full px-6 shadow-lg">
        ...
        <button onclick="document.getElementById('registration_modal').showModal()" class="btn border-none hover:bg-opacity-90 bg-secondary text-white btn-sm rounded-full px-6 shadow-lg shadow-secondary/30">
...
<dialog id="dokumen_modal" class="modal">
  <div class="modal-box bg-[#F9FAFB]">
    ...
    <h3 class="font-bold text-lg text-primary">Upload Laporan Magang</h3>
    ...
    <div class="flex flex-col gap-4 mt-2">
        ...
        <button class="btn bg-secondary hover:bg-opacity-90 border-none text-white w-full">Kirim Laporan</button>
    </div>
  </div>
</dialog>
...
<dialog id="registration_modal" class="modal">
  <div class="modal-box bg-[#F9FAFB] w-11/12 max-w-2xl">
    ...
    <h3 class="font-bold text-lg text-primary mb-4">Form Pendaftaran Magang</h3>
    <div class="space-y-4">
        <div>
        ...
        <div class="flex justify-end gap-2 mt-6">
            ...
            <button class="btn bg-secondary hover:bg-opacity-90 border-none text-white">Submit Pendaftaran</button>
        </div>
    </div>
  </div>
</dialog>
    ...
    <div class="card bg-white shadow-sm hover:shadow-md transition-shadow" style="border: 1px solid #e5e7eb;">
        <div class="card-body p-5">
            <div class="flex items-center justify-between mb-2">
                ...
                <div class="w-10 h-10 rounded-xl flex items-center justify-center bg-secondary/10 text-secondary">
            ...
            <progress class="progress progress-secondary w-full mt-2" value="62" max="100" style="height: 0.4rem;"></progress>
        </div>
    </div>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6 text-black">
    ...
    <div class="lg:col-span-2 space-y-6">
        <div class="card bg-white shadow-sm" style="border: 1px solid #e5e7eb;">
            <div class="card-body">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-bold text-lg text-primary">Progres Tahapan Magang</h3>
                </div>
        ...
        <div class="card bg-white shadow-sm" style="border: 1px solid #e5e7eb;">
            <div class="card-body">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-bold text-lg text-primary">Informasi Instansi Magang</h3>
        ...
        <div class="card bg-white shadow-sm" style="border: 1px solid #e5e7eb;">
            <div class="card-body p-5">
                <div class="flex items-center justify-between mb-4 border-b pb-2">
                    <h3 class="font-bold text-base text-primary">Dosen Pembimbing</h3>
                    <div class="badge bg-green-100 text-green-700 border-none">Aktif</div>
                </div>
                
                <div class="flex items-center gap-3 mb-4">
                    <div class="avatar placeholder">
                      <div class="rounded-full w-12 text-white flex items-center justify-center font-bold text-lg bg-primary">
                        BS
                      </div>
                    </div>
                    <div>
                ...
                <div class="space-y-4">
                    ...
                    <button class="btn btn-sm text-white border-none w-full hover:bg-opacity-90 bg-secondary">Balas Pesan / Chat Dosen</button>
                </div>
            </div>
        </div>
        ...
        <div class="card shadow-lg bg-primary text-white">
            <div class="card-body p-6 relative overflow-hidden">
                ...
                <div class="card-actions justify-end mt-4 z-10">
                    <button class="btn btn-sm bg-secondary text-white border-none hover:bg-opacity-90">Unduh PDF</button>
                </div>
            </div>
        </div>
    </div>
