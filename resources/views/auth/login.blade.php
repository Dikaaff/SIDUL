...
<div class="flex flex-col lg:flex-row w-full max-w-5xl bg-white rounded-2xl overflow-hidden shadow-2xl border border-gray-100 min-h-[500px] md:min-h-[650px] relative z-10 m-4">
    ...
    <div class="w-full lg:w-1/2 p-8 lg:p-16 text-white flex flex-col justify-between relative overflow-hidden group rounded-2xl m-2 bg-cover bg-center shadow-inner min-h-[400px] lg:min-h-auto" style="background-image: url('{{ asset('images/amikom.png') }}');">
