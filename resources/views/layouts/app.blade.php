...
<body class="bg-[#F9FAFB] font-sans antialiased text-base-content min-h-screen">
    ...
    <script>
        ...
        function showToast(type, message) {
            ...
            if (type === 'success' || type === 'info') {
                ...
                if (type === 'info') {
                    if(iconContainer) iconContainer.className = 'icon-container w-12 h-12 rounded bg-blue-100 flex items-center justify-center shadow-lg shadow-blue-500/10 text-blue-600';
                    if(titleText) titleText.innerText = 'Informasi';
                } else {
                    if(iconContainer) iconContainer.className = 'icon-container w-12 h-12 rounded bg-green-100 flex items-center justify-center shadow-lg shadow-green-500/10 text-green-600';
    ...
    <div id="globalNotifContainer" class="fixed top-8 right-8 z-[9999] space-y-4 pointer-events-none">
        ...
        <div id="globalSuccessNotif" class="hidden animate-in fade-in slide-in-from-right-8 duration-300 pointer-events-auto">
            <div class="flex items-center gap-4 bg-white/95 backdrop-blur-md border-l-4 border-green-500 shadow-2xl rounded p-5 min-w-[340px] max-w-[calc(100vw-2rem)]">
                <div class="icon-container w-12 h-12 rounded bg-green-100 flex items-center justify-center shadow-lg shadow-green-500/10 text-green-600">
        ...
        <div id="globalErrorNotif" class="hidden animate-in fade-in slide-in-from-right-8 duration-300 pointer-events-auto">
            <div class="flex items-center gap-4 bg-white/95 backdrop-blur-md border-l-4 border-red-500 shadow-2xl rounded p-5 min-w-[340px] max-w-[calc(100vw-2rem)]">
                <div class="w-12 h-12 rounded bg-red-100 flex items-center justify-center shadow-lg shadow-red-500/10 text-red-600">
